...
export class AddLogsTable1788045826492 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."logs_action_enum" AS ENUM('CREATE', 'UPDATE', 'DELETE', 'SOFT_DELETE', 'RESTORE')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_bc6f031075857a0e798642f503" ON "logs"  ("correlation_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_1d21181bfc9b5cc798be90d723" ON "logs"  ("createdAt") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_4966f94de86ae30f0fc8d2f415" ON "logs"  ("actor_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_b08f143d4f48e93ea97eaeadf5" ON "logs"  ("entity_name", "entity_id") `,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b08f143d4f48e93ea97eaeadf5"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_4966f94de86ae30f0fc8d2f415"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_1d21181bfc9b5cc798be90d723"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_bc6f031075857a0e798642f503"`,
    );
