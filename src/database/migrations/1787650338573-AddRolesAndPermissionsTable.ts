...
export class AddRolesAndPermissionsTable1787650338573 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "roles_usuarios_users" ("rolesId" uuid NOT NULL, "usersId" uuid NOT NULL, CONSTRAINT "PK_f59ce772719533bc4221edf6f21" PRIMARY KEY ("rolesId", "usersId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_d19fdc883a08dd129e3cffdc4e" ON "roles_usuarios_users"  ("rolesId") `);
        await queryRunner.query(`CREATE INDEX "IDX_81eaf87754f63968b1829eb98b" ON "roles_usuarios_users"  ("usersId") `);
        ...
        await queryRunner.query(`ALTER TABLE "roles_usuarios_users" ADD CONSTRAINT "FK_d19fdc883a08dd129e3cffdc4e2" FOREIGN KEY ("rolesId") REFERENCES "roles"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "roles_usuarios_users" ADD CONSTRAINT "FK_81eaf87754f63968b1829eb98b4" FOREIGN KEY ("usersId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "roles_usuarios_users" DROP CONSTRAINT "FK_81eaf87754f63968b1829eb98b4"`);
        await queryRunner.query(`ALTER TABLE "roles_usuarios_users" DROP CONSTRAINT "FK_d19fdc883a08dd129e3cffdc4e2"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_81eaf87754f63968b1829eb98b"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d19fdc883a08dd129e3cffdc4e"`);
